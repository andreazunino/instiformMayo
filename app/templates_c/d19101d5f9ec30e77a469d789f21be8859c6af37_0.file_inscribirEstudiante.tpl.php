<?php
/* Smarty version 5.4.0, created on 2025-12-02 20:29:13
  from 'file:inscribirEstudiante.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.0',
  'unifunc' => 'content_692f3e0929f796_27473810',
...
function content_692f3e0929f796_27473810 (\Smarty\Template $_smarty_tpl) {
...
<div class="container text-center">
 ...
 mt-3"><?php echo $_smarty_tpl->getValue('mensaje');?>
    ...
    <?php }?>
    <?php if ((null !== ($_smarty_tpl->getValue('comprobante_id') ?? null))) {?>
        <div class="alert alert-success mt-3">
            Comprobante listo. <a class="alert-link" href="comprobanteInscripcion.php?id=<?php echo $_smarty_tpl->getValue('comprobante_id');?>
" target="_blank" rel="noopener">Descargar comprobante<?php if ($_smarty_tpl->getValue('comprobante_curso')) {?> de <?php echo $_smarty_tpl->getValue('comprobante_curso');
}
if ($_smarty_tpl->getValue('comprobante_dni')) {?> (DNI <?php echo $_smarty_tpl->getValue('comprobante_dni');?>
)<?php }?></a>
        </div>
    <?php }?>
